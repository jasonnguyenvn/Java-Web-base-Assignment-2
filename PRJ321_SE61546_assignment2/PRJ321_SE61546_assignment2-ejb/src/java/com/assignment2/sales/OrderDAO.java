...
//    }
    ...
    public void searchOrdersByDateNotLoadItems(Date fromDate, 
            Date toDate, AccountDTO loginAcc, DataSource ds) 
            throws  SQLException {
    ...
    public OrderDTO getOrderByID(String orderID, AccountDTO loginAcc, DataSource ds) 
            throws SQLException{
