...
import com.assignment2.account.AccountDTO;
...
//    }
    ...
    public boolean deleteOrderDetails(int id, String orderID, 
            AccountDTO loginAcc, DataSource ds) 
            throws SQLException /*, OnlyOneDetailForOrderException  */ {
        boolean result = false;
...
//            }
    ...
    public boolean updateOrderDetailQuantity(int id, 
            String orderID, int quantity, AccountDTO loginAcc, DataSource ds) 
            throws SQLException {
        boolean result = false;
    ...
    public List<OrderDetailDTO> getOrderDetailsByOrderId(String orderID, 
        ...
        try {
            ...
            while(rs.next()) {
                ...
                ProductDTO product = this.getProduct(productID, ds);
    ...
    protected ProductDTO getProduct(String productID, DataSource ds) 
        ...
        result = dao.getProductById(productID, ds);
